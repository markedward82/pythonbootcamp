...
#print out False due to the < operator
print(3 + 2 < 5 - 7)
...
#print out string how about some mroe.
print("How about some more.")

#print out string is it great? and give a boolean
print("Is it great?", 5 > -2)
#print out string is it greater or equal? and gives a boolean
print("Is it greater or equal?", 5 >= -2)
#print out string is it less or equal? and gives a boolean
